...
export default function ThankYouInvest() {
  return (
    <div className="bg-dark min-h-screen overflow-x-hidden">
      ...
      <section className="px-5 pt-28 pb-16 md:px-8 md:pt-40 md:pb-24">
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            <h2 className="font-heading uppercase text-2xl md:text-4xl text-white">
              Ready to Take It Further?
            </h2>
            <p className="mt-4 text-muted text-sm md:text-lg max-w-xl mx-auto px-2">
              Book a free 1:1 consultation call with Ivan and let's map out
              your growth plan.
            </p>
            <motion.a
              href="#"
              ...
              className="block sm:inline-block mt-8 mx-4 sm:mx-0 min-h-[48px] flex items-center justify-center bg-primary hover:bg-primary-dark text-white font-bold text-base md:text-lg px-6 md:px-10 py-4 md:py-5 rounded-xl transition-colors"
            >
